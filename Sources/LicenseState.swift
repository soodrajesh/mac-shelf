...
/// Single source of truth for MacTools Pro license status.
///
...
final class LicenseState: ObservableObject {
    static let licenseKeyDefaultsKey = "com.rajeshsood.mactools.licenseKey"
    ...
    func refresh() async {
        ...
        do {
            ...
            verificationMessage = "License verified — MacTools Pro unlocked."
